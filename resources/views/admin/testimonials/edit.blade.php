...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fa fa-edit"></i> تعديل رأي عميل</h1>
    </section>
            ...
            <form action="{{ route('dashboard.testimonials.update', $testimonial) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 position-relative">
                        ...
                        <input type="number" name="stars" class="form-control" min="1" max="5" value="{{ $testimonial->stars }}" required>
                    </div>

                    {{-- الصورة --}}
                    <div class="col-md-6 mb-4">
                        <label class="form-label"><i class="fa fa-image"></i> صورة العميل</label>
                    ...
                    <div class="col-md-12 mb-3 position-relative">
                        ...
                        <textarea name="review" class="form-control" rows="4" required>{{ $testimonial->review }}</textarea>
                    </div>
